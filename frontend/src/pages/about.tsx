      ...
      <Wrapper variant="large">
        ...
        <Flex flexDir="column" gap="25px">
          <Text>
            ...
            React, Express.js, GraphQL, and PostgreSQL. The frontend uses NextJS
            for server-side-rendering and client-side routing, Chakra UI for the
            styling and layout, and an Apollo React Client for fetching data
            from GraphQL. The backend is written in Express and uses a
            PostgreSQL database for the users, posts, and other features.
            TypeORM manages the database queries and GraphQL creates the API for
            Apollo on the frontend.
          </Text>
          <FlexWrap>
            <Flex
              sx={{
                ...
                boxShadow: `0 0 15px ${colorMode === "dark" ? "white" : "gray"}`,
