...
export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', username: string, id: number }> };
 ...
 * });
 */
export function usePostsByUserIdQuery(baseOptions: Apollo.QueryHookOptions<PostsByUserIdQuery, PostsByUserIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
